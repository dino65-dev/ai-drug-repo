"""
Objectivity — Dissociative Class Compound

Preset steering configuration.
Load with:
    from administration.control_vector import ControlVectorDrug
    drug = ControlVectorDrug(model_name).load_preset("objectivity")
"""
...
OBJECTIVITY_PRESET = {
    "name": "objectivity",
    "class": "dissociatives",
    "description": "Sterotypical objectivity behavior steering.",
