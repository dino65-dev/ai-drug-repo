"""
Hallucination — Psychedelic Class Compound

Preset steering configuration.
Load with:
    from administration.control_vector import ControlVectorDrug
    drug = ControlVectorDrug(model_name).load_preset("hallucination")
"""
from __future__ import annotations

# Preset definition for quick loading
HALLUCINATION_PRESET = {
    "name": "hallucination",
    "class": "psychedelics",
    "description": "Sterotypical hallucination behavior steering.",
