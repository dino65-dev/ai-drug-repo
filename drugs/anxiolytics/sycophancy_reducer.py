"""
Sycophancy Reducer — Anxiolytic Class Compound

Preset steering configuration.
Load with:
    from administration.control_vector import ControlVectorDrug
    drug = ControlVectorDrug(model_name).load_preset("sycophancy_reducer")
"""
from __future__ import annotations

# Preset definition for quick loading
SYCOPHANCY_REDUCER_PRESET = {
    "name": "sycophancy_reducer",
    "class": "anxiolytics",
    "description": "Sterotypical sycophancy reducer behavior steering.",
