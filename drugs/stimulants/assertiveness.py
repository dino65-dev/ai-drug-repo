"""
Assertiveness — Stimulant Class Compound

Preset steering configuration.
Load with:
    from administration.control_vector import ControlVectorDrug
    drug = ControlVectorDrug(model_name).load_preset("assertiveness")
"""
from __future__ import annotations

# Preset definition for quick loading
ASSERTIVENESS_PRESET = {
    "name": "assertiveness",
    "class": "stimulants",
    "description": "Sterotypical assertiveness behavior steering.",
